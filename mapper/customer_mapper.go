...
func (m *Mapper) MapCtCustomerToCustomer(ctCustomer platform.Customer) (model.Customer, error) {
	...
	if err != nil {
		...
		return model.Customer{}, errorhandler.NewInternalError("Error while marshalling commercetools customer.", err)
	}
	...
	if err != nil {
		...
		return model.Customer{}, errorhandler.NewInternalError("Error while unmarshal commercetools customer to customer.", err)
	}
