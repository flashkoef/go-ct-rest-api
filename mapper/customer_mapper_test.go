...
func TestMapCtCustomerToCustomer(t *testing.T) {
	m := NewMapper()
	mappedCustomer := m.MapCtCustomerToCustomer(ctCustomer)
	assert.Equal(t, expCustomer, mappedCustomer)
}

func TestMapCtCustomerToCustomerWithEmptyAddresses(t *testing.T) {
	m := NewMapper()
	mappedCustomer := m.MapCtCustomerToCustomer(ctCustomerWithEmptyAddresses)
...
func TestCtCustomerToCustomerWithEmptyCustomerFields(t *testing.T) {
	m := NewMapper()
	mappedCustomer := m.MapCtCustomerToCustomer(ctCustomerWithEmptyFields)
...
func TestMapCtCustomerToCustomerWithEmptyAddressFields(t *testing.T) {
	m := NewMapper()
	mappedCustomer := m.MapCtCustomerToCustomer(ctCustomerWithEmptyAddressFields)
